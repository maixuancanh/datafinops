const secretKey = /(?:authorization|credential|keystore|mnemonic|passphrase|password|private.?key|recovery.?phrase|secret|seed.?phrase|token)/i;
const financeKey = /(?:amount|budget|cost|minor.?units|revenue|savings|spend)/i;
const sensitiveText = /(?:authorization|credential|mnemonic|password|private.?key|secret|seed.?phrase)\s*[=:]\s*[^\s,;]+/gi;
